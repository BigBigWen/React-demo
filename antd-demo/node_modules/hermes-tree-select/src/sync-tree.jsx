...
import { toggle, DEFAULT_SYNC_NODE_TEXT, DEFAULT_NO_FOUND_CONTENT } from './utils';
...
class SyncTree extends Component {
  ...
  componentWillReceiveProps(props) {
    ...
    if (treeData !== this.props.treeData) {
      ...
      if (!searchValue) {
        ...
        const searchModel = model.search((node) => {
  ...
  getNode(node, isRight) {
    ...
    const nodeText = (item) => { return _nodeText.call(model, item, isRight); };
    let expand;
    if (isRight) {
        ...
        <div className="header">
          {
            rootLeafCount && showCheckAll ? (
              <Node node={tree} onCheck={this.onCheck.bind(this, '#', false)} nodeText={() => false} />
            ) : false
          }
