...
var Clamp = (_temp = _class = function (_React$Component) {
  ...
  Clamp.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps, nextState) {
    if (!nextState.ellipsisInit) return true;
    return this.diffChildren(nextProps, this.props);
  };

  Clamp.prototype.componentDidMount = function componentDidMount() {
    var _this2 = this;
  ...
  Clamp.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
    if (this.diffChildren(this.props, prevProps)) {
      this.multiClamp.reload();
    }
  };

  Clamp.prototype.diffChildren = function diffChildren(nextProps, prevProps) {
  ...
  Clamp.prototype.render = function render() {
    var _this3 = this;
